				...
				<div class="col-md-8 col-sm-7 blog-posts">
					...
					<div class="post-item">
						...
						<div class="post-content">
							...
							<a href="<?php echo base_url(); ?>blog-post" class="read-more">Read More</a>
						</div>
					</div>
					<!-- Post item -->
					<div class="post-item">
				...
				<div class="col-md-4 col-sm-5 sidebar">
					...
					<div class="widget-item">
						...
						<ul class="instagram">
							...
							<li><img src="assets/img/instagram/2.jpg" alt=""></li>
							<li><img src="assets/img/instagram/3.jpg" alt=""></li>
							<li><img src="assets/img/instagram/4.jpg" alt=""></li>
							<li><img src="assets/img/instagram/5.jpg" alt=""></li>
							<li><img src="assets/img/instagram/6.jpg" alt=""></li>
						</ul>
					</div>
					<!-- Single widget -->
					<div class="widget-item">
